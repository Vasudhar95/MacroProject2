...
%parameters
parameters alpha beta delta sigma zss sigmaz rhoz;

%parameters: steady state variables declared as parameters within Dynare
parameters css investss yss nss kss U_css;
...
[outc,fval,eflag]=fsolve(@neoclassical_calibration,feed,options_fsolve_silent);
...
stoch_simul(order=1,periods=2100,irf=0,hp_filter=1600) y k invest c;
